        ...
        try
        {
          ...
          if ((len == -1) || (inSocket.isOutputShutdown())) {
            ...
            outSocket.shutdownOutput();
             ...
             new  GlobalVars().logThis("<#> Thread " + getId() + ": error in data transfer. " + e.getMessage());
          ...
          if (isThread2Closed) {
            try {
              ...
              cliente.close();
                     ...
                     new  GlobalVars().logThis("<#> Thread " + getId() + ": error in closing communication. " + e.getMessage());
